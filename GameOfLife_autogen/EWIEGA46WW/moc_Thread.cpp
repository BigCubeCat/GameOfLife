...
QT_MOC_LITERAL(1, 7, 10), // "loop_event"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 4) // "loop"

    },
    "Thread\0loop_event\0\0loop"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::loop_event)) {
                *result = 0;
                return;
            }
        }
