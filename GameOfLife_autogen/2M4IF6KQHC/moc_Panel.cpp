...
QT_MOC_LITERAL(1, 6, 10), // "updateData"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 10), // "playSignal"
QT_MOC_LITERAL(4, 29, 10), // "stopSignal"
QT_MOC_LITERAL(5, 40, 10), // "stepSignal"
QT_MOC_LITERAL(6, 51, 13), // "clearSettings"
QT_MOC_LITERAL(7, 65, 13) // "applySettings"

    },
    "Panel\0updateData\0\0playSignal\0stopSignal\0"
    "stepSignal\0clearSettings\0applySettings"
};
...
void Panel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->playSignal(); break;
        case 2: _t->stopSignal(); break;
        case 3: _t->stepSignal(); break;
        case 4: _t->clearSettings(); break;
        ...
        {
            using _t = void (Panel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Panel::updateData)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Panel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Panel::playSignal)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Panel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Panel::stopSignal)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Panel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Panel::stepSignal)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 1
void Panel::playSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Panel::stopSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void Panel::stepSignal()
{
