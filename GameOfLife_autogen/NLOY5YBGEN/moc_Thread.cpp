...
QT_MOC_LITERAL(1, 7, 18), // "generationFinished"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 13), // "QVector<bool>"
QT_MOC_LITERAL(4, 41, 3) // "run"

    },
    "Worker\0generationFinished\0\0QVector<bool>\0"
    "run"
};
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->generationFinished((*reinterpret_cast< QVector<bool>(*)>(_a[1]))); break;
        case 1: _t->run(); break;
        default: ;
        }
        ...
        {
            using _t = void (Worker::*)(QVector<bool> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Worker::generationFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Worker::generationFinished(QVector<bool> _t1)
{
