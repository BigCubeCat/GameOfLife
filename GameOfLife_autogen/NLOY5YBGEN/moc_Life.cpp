...
QT_MOC_LITERAL(1, 5, 18), // "generationFinished"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 14) // "nextGeneration"

    },
    "Life\0generationFinished\0\0nextGeneration"
};
...
void Life::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Life::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Life::generationFinished)) {
                *result = 0;
                return;
            }
        }
